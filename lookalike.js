const lookalike = {
  ...
  // Less common / extended Cyrillic homoglyphs
  'ґ': 'r',
  'Ї': 'I',
  'ї': 'i',
  'Ғ': 'F',
  ...
  // Full-width Latin uppercase (Ａ-Ｚ)
  'Ａ': 'A',
  'Ｂ': 'B',
  'Ｃ': 'C',
  'Ｄ': 'D',
  ...
  // Full-width Latin lowercase (ａ-ｚ)
  'ａ': 'a',
  'ｂ': 'b',
  'ｃ': 'c',
  'ｄ': 'd',
  ...
  // Latin small capitals (IPA extensions)
  'ᴀ': 'a',
  'ʙ': 'b',
  'ᴄ': 'c',
  'ᴅ': 'd',
  ...
  // Double-struck italic (U+2145–U+2149)
  'ⅅ': 'D', 'ⅆ': 'd', 'ⅇ': 'e', 'ⅈ': 'i', 'ⅉ': 'j',

  // Cherokee syllabary confusables
  // Uppercase (U+13A0–U+13FF) / Lowercase (U+AB70–U+ABBF)
  'Ꭺ': 'O', 'ꭺ': 'o',
  'Ꭻ': 'J', 'ꭻ': 'j',
  'Ꭽ': 'H', 'ꭽ': 'h',
  'Ꭾ': 'E', 'ꭾ': 'e',
  ...
  // Latin-1 Supplement — accented uppercase (U+00C0–U+00DE)
  ...
  // Latin-1 Supplement — accented lowercase (U+00E0–U+00FF)
  'à': 'a', 'á': 'a', 'â': 'a', 'ã': 'a', 'ä': 'a', 'å': 'a', 'æ': 'ae',
  'ç': 'c',
  'è': 'e', 'é': 'e', 'ê': 'e', 'ë': 'e',
  'ì': 'i', 'í': 'i', 'î': 'i', 'ï': 'i',
  ...
  // Latin Extended-B — selected confusables (U+0180–U+024F)
  'ƀ': 'b', 'Ƀ': 'B', 'Ɓ': 'B', 'Ƃ': 'B', 'ƃ': 'b',
  'Ƈ': 'C', 'ƈ': 'c',
  'Ɖ': 'D', 'Ɗ': 'D', 'Ƌ': 'D', 'ƌ': 'd',
  'ƍ': 'd',
  ...
  'Ȧ': 'A', 'ȧ': 'a', 'Ȩ': 'E', 'ȩ': 'e',
  'Ȯ': 'O', 'ȯ': 'o', 'Ȳ': 'Y', 'ȳ': 'y',
  'Ⱥ': 'A', 'Ȼ': 'C', 'ȼ': 'c', 'Ƚ': 'L', 'ƚ': 'l', 'Ⱦ': 'T', 'ⱦ': 't',
  'Ɉ': 'J', 'ɉ': 'j', 'Ɍ': 'R', 'ɍ': 'r', 'Ɏ': 'Y', 'ɏ': 'y',
  'Ⱡ': 'L', 'ⱡ': 'l', 'Ⱨ': 'H', 'ⱨ': 'h', 'Ⱪ': 'K', 'ⱪ': 'k', 'Ⱬ': 'Z', 'ⱬ': 'z',

  // Latin Extended Additional — precomposed with diacritics (U+1E00–U+1EFF)
  ...
  // Modifier Letter capitals (superscript-sized, U+1D2C–U+1D42)
  'ᴬ': 'A', 'ᴮ': 'B', 'ᴰ': 'D', 'ᴱ': 'E', 'ᴳ': 'G', 'ᴴ': 'H', 'ᴵ': 'I', 'ᴶ': 'J',
  'ᴷ': 'K', 'ᴸ': 'L', 'ᴹ': 'M', 'ᴺ': 'N', 'ᴼ': 'O', 'ᴾ': 'P', 'ᴿ': 'R', 'ᵀ': 'T',
  'ᵁ': 'U', 'ᵂ': 'W',

  // Modifier Letter small (superscript lowercase)
  'ᵃ': 'a', 'ᵇ': 'b', 'ᶜ': 'c', 'ᵈ': 'd', 'ᵉ': 'e', 'ᶠ': 'f', 'ᵍ': 'g', 'ʰ': 'h',
  'ʲ': 'j', 'ᵏ': 'k', 'ˡ': 'l', 'ᵐ': 'm', 'ᵒ': 'o', 'ᵖ': 'p', 'ʳ': 'r', 'ˢ': 's',
  ...
  // Subscript letters
  'ₐ': 'a', 'ₑ': 'e', 'ₒ': 'o', 'ᵤ': 'u', 'ₓ': 'x', 'ₕ': 'h', 'ₖ': 'k', 'ₗ': 'l',
  'ₘ': 'm', 'ₙ': 'n', 'ₚ': 'p', 'ₛ': 's', 'ₜ': 't', 'ᵧ': 'y',

  // Subscript digits
  '₀': '0', '₁': '1', '₂': '2', '₃': '3', '₄': '4',
  '₅': '5', '₆': '6', '₇': '7', '₈': '8', '₉': '9',

  // Additional letterlike symbols (Script / Fraktur / Double-Struck gaps)
  'ℬ': 'B',
  'ℰ': 'E',
  'ℱ': 'F',
  'ℋ': 'H',
  ...
  // Mathematical Bold uppercase/lowercase
  ...
  // Mathematical Italic uppercase/lowercase
  ...
  // Mathematical Bold Italic uppercase/lowercase
  ...
  // Mathematical Fraktur uppercase/lowercase
  '𝔄': 'A', '𝔅': 'B', '𝔇': 'D', '𝔈': 'E', '𝔉': 'F', '𝔊': 'G', '𝔍': 'J', '𝔎': 'K',
  '𝔏': 'L', '𝔐': 'M', '𝔑': 'N', '𝔒': 'O', '𝔓': 'P', '𝔔': 'Q', '𝔖': 'S', '𝔗': 'T',
  '𝔘': 'U', '𝔙': 'V', '𝔚': 'W', '𝔛': 'X', '𝔜': 'Y',
  ...
  // Mathematical Double-Struck uppercase/lowercase
  '𝔸': 'A', '𝔹': 'B', '𝔻': 'D', '𝔼': 'E', '𝔽': 'F', '𝔾': 'G', '𝕀': 'I', '𝕁': 'J',
  '𝕂': 'K', '𝕃': 'L', '𝕄': 'M', '𝕆': 'O', '𝕊': 'S', '𝕋': 'T', '𝕌': 'U', '𝕍': 'V',
  '𝕎': 'W', '𝕏': 'X', '𝕐': 'Y',
  ...
  // Mathematical Bold Fraktur uppercase/lowercase
  ...
  // Mathematical Sans-Serif uppercase/lowercase
  ...
  // Mathematical Sans-Serif Bold uppercase/lowercase
  ...
  // Mathematical Sans-Serif Italic uppercase/lowercase
  ...
  // Mathematical Sans-Serif Bold Italic uppercase/lowercase
  ...
  // Mathematical Monospace uppercase/lowercase
  ...
  // Mathematical digits (Bold, Sans-Serif, Sans-Serif Bold, Monospace)
  ...
  // Negative circled Latin uppercase (🅐-🅩)
  '🅐': 'A',
  '🅑': 'B',
  '🅒': 'C',
  '🅓': 'D',
  ...
  // Negative squared Latin uppercase (🅰-🆉)
  '🅰': 'A',
  '🅱': 'B',
  '🅲': 'C',
  '🅳': 'D',
  ...
  // Roman numeral symbols (U+2160–U+217F)
  ...
  // Phonetic Extensions Supplement — palatal hook variants (U+1D80–U+1D8E)
  'ᶀ': 'b', 'ᶁ': 'd', 'ᶂ': 'f', 'ᶃ': 'g', 'ᶄ': 'k', 'ᶅ': 'l', 'ᶆ': 'm',
  'ᶇ': 'n', 'ᶈ': 'p', 'ᶉ': 'r', 'ᶊ': 's', 'ᶋ': 's', 'ᶌ': 'v', 'ᶍ': 'x', 'ᶎ': 'z',

  // Lisu script confusables (U+A4D0–U+A4FF)
  'ꓐ': 'B',
  'ꓑ': 'P',
  'ꓒ': 'F',
  'ꓓ': 'D',
  ...
  // Runic confusables (U+16A0–U+16FF)
  'ᚠ': 'f',
  'ᚢ': 'n',
  'ᚱ': 'r',
  'ᚲ': 'c',
  ...
  // Tai Viet confusables (U+AA80–U+AADF)
  'ꪋ': 'a',
  'ꪔ': 'm',
  'ꪑ': 'm',
  'ꪕ': 'n',
